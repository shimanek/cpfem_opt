...
def main():
	...
	plt.rcParams.update(
		{
			...
			"savefig.facecolor": "#131416",
			"patch.facecolor": "#131416",
		}
	)
	## data:
	...
	plot_SS(
		[old235, new235],
		["Old B.C., 100 Elements", "New B.C., 1 Element"],
		"Model and B.C. Comparison",
		"fig_ModelCompare_235",
	)
	plot_SS(
		[old128, new128, fullGeo128],
		[
			"Old B.C., 100 Elements",
			"New B.C., 1 Element",
			"Full Mesh, $2\cdot10^{4}$ Elements",
		],
		"Model Comparison [128]",
		"fig_ModelCompare_128_fullGeo",
	)
